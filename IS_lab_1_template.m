...
for i=6:13
    ...
    % calculate the error
    E(i) = T(i) - y;
    fprintf('%d: y = %d, T = %d, klaida = %d\n', i, y, T(i), E(i));
end
e = abs(E(6)) + abs(E(7)) + abs(E(8)) + abs(E(9)) + abs(E(10)) + abs(E(11)) + abs(E(12)) + abs(E(13));
fprintf('Testavimo bendra klaida: %d\n', e);
